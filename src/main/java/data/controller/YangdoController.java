...
public class YangdoController {
    ...
    @GetMapping("list2")
    public List<YangdoDto> list2(int page, int size) {
        System.out.println("스크롤");
        int offset = (page - 1) * size;
        // List<YangdoDto> list = yangdoMapper.getPagingListScroll(keyword, offset,
        // size);
    ...
    public List<YangdoDto> searchList(@RequestParam(defaultValue = "") String keyword) {
        System.out.println(keyword);
        List<YangdoDto> list = yangdoMapper.getPagingListScrollSearch(keyword);
        return list;
    }

    @GetMapping("/myyangdoList")
    public List<YangdoDto> myyangdoList(int unum, int page, int size) {
        System.out.println("스크롤");
        int offset = (page - 1) * size;
        List<YangdoDto> list = yangdoMapper.getPagingMyListScroll(unum, offset, size);
        System.out.println(list);
        return list;
    }

    @GetMapping("/myyangdoListSearch")
    public List<YangdoDto> myyangdoListSearch(int unum, @RequestParam(defaultValue = "") String keyword) {
        System.out.println(keyword);
        List<YangdoDto> list = yangdoMapper.getPagingMyListScrollSearch(unum, keyword);
        return list;
    }
}
